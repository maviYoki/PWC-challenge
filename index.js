...
console.log(reversePhrase('Hello, World! OpenAI is amazing.'));
console.log(removeDuplicate('Hello, World!'));
console.log(findBiggestPalindrome('babad'));
console.log(capitalizeFirstLetter("hello. how are you? i'm fine, thank you."));
console.log(isAnagramOfPalindrome('racecar'));
